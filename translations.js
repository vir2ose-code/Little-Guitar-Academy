const translations = {
    de: {
        ...
        msgSuccess: "Vielen Dank! Deine Nachricht wurde gesendet.",
        msgError: "Hoppla! Da ist etwas schiefgelaufen.",
    ...
    en: {
        ...
        msgSuccess: "Thank you! Your message has been sent.",
    ...
    pl: {
        ...
        msgSuccess: "Dziękujemy! Twoja wiadomość została wysłana.",
        msgError: "Ojej! Coś poszło nie tak.",
    ...
    es: {
        ...
        msgSuccess: "¡Gracias! Tu mensaje ha sido enviado.",
        msgError: "¡Ups! Algo salió mal.",
